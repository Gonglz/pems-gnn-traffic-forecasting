...
Multi‑Head RF‑GraphSAGE trainingnote
- note: 5/15/30min edge_index
- note: X_ext.npy (flow, occupancy, speed, tavg, pcpn, is_weekend)
- note: Y.npy (flow)
- note, note, torch.compile, DDP noterows & note debug
...
def parse_args():
    ...
    p.add_argument('--debug', action='store_true',
                   help='note: note DataParallel note pdb')
