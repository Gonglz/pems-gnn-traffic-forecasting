...
RAW_DIR       = PEMS_ROOT / "pems_dataset"                    # 原始 raw.txt 存放
OUT_LONG      = PEMS_ROOT / "step1_raw_long.csv"              # 输出长表
OUT_META      = PEMS_ROOT / "step1_station_meta.csv"          # 输出元数据
...
def main():
    if not RAW_DIR.exists():
        raise FileNotFoundError(f"找不到原始数据目录：{RAW_DIR}")
